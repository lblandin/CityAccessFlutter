...
class _BasketballPageState extends State<BasketballPage> {
  RulesModel rm1 = new RulesModel(
      "3v3 ou 5v5",
      "assets/icon/basketball-court.png",
      "Le basket peut se jouer en 3v3 ou 5v5");
  ...
  RulesModel rm5 = new RulesModel(
      "Les contacts",
      "assets/icon/martial-arts.png",
      "Les contacts sont à éviter sous peines de fautes");
  ...
  RulesModel rm7 = new RulesModel(
      "3 sec dans la raquette",
      "assets/icon/basketball_ball.png",
  ...
  RulesModel rm9 = new RulesModel("Portée de balle", "assets/icon/balle.png",
      "Il est interdit de porter la balle");
  ...
  @override
  void initState() {
    basketRules.addAll([rm1,rm2,rm3,rm4,rm5,rm6,rm7,rm8,rm9,rm10]);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: RulesWidget(
            context,
            "assets/basketball_court.jpg",
            "Règles de Basketball",
            basketRules)); //Widget with "Material design"
  }
}
